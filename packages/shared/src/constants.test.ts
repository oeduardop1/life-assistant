...
describe('STORAGE_LIMITS', () => {
  describe('free plan', () => {
    it('should have correct storage limits', () => {
      ...
      expect(STORAGE_LIMITS.free.activeDecisions).toBe(5);
  ...
  describe('pro plan', () => {
    it('should have correct storage limits', () => {
      ...
      expect(STORAGE_LIMITS.pro.activeDecisions).toBe(50);
  ...
  describe('premium plan', () => {
    it('should have unlimited values', () => {
      ...
      expect(STORAGE_LIMITS.premium.activeDecisions).toBeNull();
