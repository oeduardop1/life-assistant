...
// =============================================================================
// Bill Actions Bottom Sheet
// =============================================================================

interface BillActionsSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  billName: string;
  isPaid: boolean;
...
/**
 * BillActionsSheet - Pre-configured bottom sheet for bill actions
 */
export function BillActionsSheet({
  open,
  onOpenChange,
  billName,
  isPaid,
  ...
  onEdit,
  onDelete,
}: BillActionsSheetProps) {
  const actions: ActionItem[] = [];

  if (onPay) {
    actions.push({
      id: 'pay',
      label: isPaid ? 'Marcar como Pendente' : 'Marcar como Pago',
      icon: Check,
      onClick: onPay,
      variant: isPaid ? 'default' : 'success',
    });
  }
