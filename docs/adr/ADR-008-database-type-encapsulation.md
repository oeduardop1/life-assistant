...
Per docs/specs/core/architecture.md, seguimos Clean Architecture com camadas bem definidas:
...
- ✅ **Consistente com docs/specs/core/architecture.md**: Segue padrão de encapsulação de packages
...
- Vai contra TypeScript strict mode (docs/specs/core/architecture.md)
...
Veja docs/specs/core/architecture.md "Package Patterns and Conventions" para mais detalhes.

## Referências

- Clean Architecture Layers: docs/specs/core/architecture.md
- Package Dependency Rules: docs/specs/core/architecture.md
