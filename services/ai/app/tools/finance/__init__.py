"""Finance tools — 9 READ tools for the finance domain (WRITE tools added in M4.5 session 2)."""
...
# No write tools yet — will be added in M4.5 session 2
FINANCE_WRITE_TOOLS: set[str] = set()
